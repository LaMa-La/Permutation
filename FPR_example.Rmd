---
title: "FPR analysis with permutation"
author: "Laura"
date: "2024-03-01"
output:
  html_document:
...
```{r}
psuper_palmo <-readRDS("/data/Femmunity/analysis/laura/external_data/240812_psupertime_palmo.rds")
```

```{r, message=FALSE}
Idents(seurat_analysis) <- "orig.ident"
...
```{r}
#undebug("plot.pseudotime.permutation")
